...
from a3c_helper import a3c_train, a3c_train_commnet
...
def main():
    ...
    parser = argparse.ArgumentParser('A3C Starcraft: Train')
    parser.add_argument('--name', type=str, default='starcraft', help='Experiment name, all outputs will be saved in checkpoints/[name]/')
    ...
    parser.add_argument('--lr', type=float, default=0.001, help='Learning rate (default: 7e-4)')
    parser.add_argument('--beta', type=float, default=0.05, help='Weight for entropy (default: 1e-2)')
    parser.add_argument('--weight_decay', type=float, default=0.0, help='Weight deacy (default: 0)')

    parser.add_argument('--seed', type=int, default=1, help='Random seed (default: 1)')
    parser.add_argument('--t_max', type=int, default=32, help='# of forward steps in A3C (default: 5)')        
    parser.add_argument('--n_steps', type=int, default=2*10**6, help='Max steps to run (default: 8e7)')
    parser.add_argument('--n_processes', type=int, default=8, help='# of training processes (default: 8)')
    parser.add_argument('--save_intervel', type=int, default=200000, help='Frequency of model saving (default: 2000000)')
    ...
    parser.add_argument('--ip', type=str, default="", help = 'server ip')
